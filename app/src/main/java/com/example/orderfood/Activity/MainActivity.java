...
import com.example.orderfood.Adapter.BestFoodsAdapter;
import com.example.orderfood.Adapter.CategoryAdapter;
import com.example.orderfood.Domain.Category;
import com.example.orderfood.Domain.Foods;
import com.example.orderfood.Domain.Location;
import com.example.orderfood.Domain.Price;
import com.example.orderfood.Domain.Time;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if (list.size() > 0){
                        ...
                        RecyclerView.Adapter adapter = new BestFoodsAdapter(list, MainActivity.this);
